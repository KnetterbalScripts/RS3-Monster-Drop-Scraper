...
class MonsterScraperApp {
    ...
    generateLuaContent(monsterName, drops) {
        const sanitizedName = monsterName.replace(/[^a-zA-Z0-9]/g, '_');
        const timestamp = new Date().toISOString();
        
        let luaContent = `-- ${monsterName} Drops\n`;
        luaContent += `-- Generated by RS3 Monster Drop Scraper\n`;
        luaContent += `-- Scraped at: ${timestamp}\n`;
        luaContent += `-- Total drops: ${drops.length}\n\n`;
        
        luaContent += `local ${sanitizedName}_drops = {`;
        ...
        // Format IDs in rows of ~15 items for readability (like your example)
        const idsPerRow = 15;
        ...
        luaContent += `}\n\n`;
        luaContent += `return ${sanitizedName}_drops\n`;
